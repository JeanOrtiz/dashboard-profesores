(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('@angular/forms'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('mateh-ng-m-validation', ['@angular/core','exports', '@angular/core', '@angular/forms', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory(global.ng.core,global['mateh-ng-m-validation'] = {}, global.ng.core, global.ng.forms, global.rxjs, global.rxjs.operators));
}(this, (function (ɵngcc0,exports, core, forms, rxjs, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NgMValidationComponentBase = /** @class */ (function () {
        function NgMValidationComponentBase() {
        }
        NgMValidationComponentBase.prototype.ngOnInit = function () {
        };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgMValidationComponentBase, [{
        ...
        return NgMValidationComponentBase;
    }());
    ...
    var FormComponentBase = /** @class */ (function () {
        ...
        FormComponentBase.prototype.subscribe = function (form, inputsArray) {
            ...
            var controlBlurs = inputsArray.map(function (formControl) {
                return rxjs.fromEvent(formControl.nativeElement, "blur");
            });
            // Merge the blur event observable with the valueChanges observable so we only need to subscribe once.
            this.mySubs = rxjs.merge.apply(void 0, __spread([form.valueChanges], controlBlurs)).pipe(operators.debounceTime(300))
        ...
        FormComponentBase.prototype.logValidationErrors = function (group) {
            ...
            Object.keys(group.controls).forEach(function (key) {
                ...
                if (abstractControl instanceof forms.FormGroup ||
                    abstractControl instanceof forms.FormArray) {
        ...
        __decorate([
            core.ViewChildren(forms.FormControlName, { read: core.ElementRef })
...
FormComponentBase.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: FormComponentBase, viewQuery: function FormComponentBase_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(forms.FormControlName, true, core.ElementRef);
    } if (rf & 2) {
        var _t;
    ...
    exports.CrossFieldErrorMatcher = CrossFieldErrorMatcher;
    exports.FormComponentBase = FormComponentBase;
    exports.NgMValidationComponentBase = NgMValidationComponentBase;
    exports.NgMValidationModule = NgMValidationModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=mateh-ng-m-validation.umd.js.map